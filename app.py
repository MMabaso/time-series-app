...
description =   '''
                **TimeAnalizer** is a time series App that will help you to forecast the future from historical data. 
...
if show_absolute_plot:
    ...
    figsize = figsize=(15,8)
    fig = plt.figure(figsize=figsize)
    layout=(1,1)
    ts_ax = plt.subplot2grid(layout, (0,0), colspan=2)
    df[y].plot(ax=ts_ax)
    plt.title('Absolute historical data', fontsize=14,fontweight='bold', loc='left')
    st.pyplot()
